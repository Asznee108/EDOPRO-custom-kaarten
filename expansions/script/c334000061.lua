...
function s.spcostfilter(c,tp)
	return c:IsSetCard(0xf0) and c:IsMonster()
        and Duel.IsExistingMatchingCard(s.spfilter,tp,LOCATION_DECK+LOCATION_GRAVE,0,1,nil,c:GetCode()) and not c:IsPublic()
end
