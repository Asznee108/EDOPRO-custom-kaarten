...
s.listed_names={CARD_ASSAULT_MODE,70902743,80666118}
s.assault_mode=70902743,80666118
...
function s.spfilter(c,e,tp)
	return (c:IsCode(70902743) or c:IsOriginalCode(80666118)) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
