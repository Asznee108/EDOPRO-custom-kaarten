...
s.listed_names={333200062}
s.listed_series={0xcf}
function s.valfilter(c)
	return c:IsLocation(LOCATION_GRAVE) and c:IsType(TYPE_TUNER)
end
function s.val(e,c)
	return Duel.GetMatchingGroupCount(s.valfilter,e:GetHandlerPlayer(),LOCATION_GRAVE,0,nil)
end
...
function s.filter(c,e,tp)
	return c:IsCode(333200062) and c:IsCanBeSpecialSummoned(e,SUMMON_TYPE_SYNCHRO,tp,false,false)
end
