...
function s.spfilter(c,e,tp)
	return ((c:IsLevelBelow(4) and c:IsSetCard(0x107a) and c:IsAttribute(ATTRIBUTE_LIGHT) 
    or (c:IsRace(RACE_BEAST) and c:IsAttribute(ATTRIBUTE_WIND)) and c:IsLevelBelow(6))) 
    and c:IsCanBeSpecialSummoned(e,0,tp,false,false,POS_FACEUP) and not c:IsCode(id)
end
