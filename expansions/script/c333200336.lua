...
function s.cfilter(c,tp)
	return c:IsSetCard(0xbbc) and c:HasLevel() and Duel.GetFieldGroupCount(tp,LOCATION_DECK,0)>=c:GetLevel()
		and Duel.GetDecktopGroup(tp,c:GetLevel()):IsExists(Card.IsAbleToHand,1,nil)
end
