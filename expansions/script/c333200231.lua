...
s.listed_names={333200271,333200272,333200227}
function s.filter(c,e,tp)
	return (c:IsCode(333200271) or c:IsCode(333200272)) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
...
function s.matfilter(c)
	return c:IsFaceup() and c:IsCode(333200227)
end
