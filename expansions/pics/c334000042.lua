...
function s.destg(e,tp,eg,ep,ev,re,r,rp,chk)
    ...
    if chk==0 then return e:GetHandler():IsDestructable()
        and Duel.IsExistingMatchingCard(Card.IsNegatable,tp,LOCATION_ONFIELD,nil) end
    Duel.SetOperationInfo(0,CATEGORY_DESTROY,e:GetHandler(),1,tp,LOCATION_MZONE)
    Duel.SetOperationInfo(0,CATEGORY_DISABLE,Duel.GetMatchingGroup(Card.IsNegatable,tp,0,LOCATION_MZONE,nil),1,1-tp,LOCATION_ONFIELD)
end
